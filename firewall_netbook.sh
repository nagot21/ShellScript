...
WLAN="wlan0"
REG_PORTS="110 995 25 465 143 993 111 2049 50220 52579 47532 54981 55893 55815" # Put here the ports you want to be left open
#PORTS=`cat /tmp/ports`
...
do
	...
	$ipt -A INPUT -p tcp -i $WLAN --dport $PORTS -j ACCEPT
	$ipt -A INPUT -p udp -i $WLAN --dport $PORTS -j ACCEPT
	$ipt -A INPUT -p tcp -i $LAN --dport $PORTS -j ACCEPT
	$ipt -A INPUT -p udp -i $LAN --dport $PORTS -j ACCEPT
